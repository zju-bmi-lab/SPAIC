...
:code:`_connections` that save the neurongroups and connections. As the main interface for network model, it contains \
...
Projection
-------------------------
:code:`Projection` is a high-level abstract class of topology, instead of :code:`Connection` , :code:`Project` represent \
...
Connection
--------------------------
:code:`spaic.Connection` is used to build connections between neurongroups, it also used to construct different synapses.
